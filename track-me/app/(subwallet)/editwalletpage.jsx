...
import { updateWallet, deleteWallet, getWallet } from '../../firebase/firestore';
...
export default function EditWalletPage() {
  ...
  const isFocusedAlt = useIsFocused();
  ...
  const handleSave = async () => {
      ...
      try {
          await addWallet(user.uid, title, totalAmount, currAmount, note, startDate, endDate);
      } catch (error) {
          ...
          <View style={{ flexDirection:"row", top: 60 }}>
            ...
            <View style={styles.inputContainer}>
              <TextInput
                ...
                value={wallet ? wallet.totalAmount : ''}
          ...
          <View style={{ flexDirection:"row", top: 75 }}>
            ...
            <View style={styles.inputContainer}>
              <TextInput
                ...
                autoCapitalize='none'
                keyboardType = 'numeric'
                value={wallet ? wallet.currAmount : ''}
                onChangeText={setCurrAmount} />
            </View>
          </View>
