    ...
    <View style={styles.container}>
      ...
      <View style={{ flex: 2 }}>
        ...
        <View style={{ flexDirection:"row"  }}>
          <TouchableOpacity style={styles.submitContainer} onPress={() => {navigation.goBack();}}>
            <Text style={ styles.setWhite }>Back to Sign in</Text>
          </TouchableOpacity>

          <TouchableOpacity style={styles.submitContainer} onPress={handleresetPassword}>
              <Text style={ styles.setWhite }>Reset Password</Text>
          </TouchableOpacity>
          
          <Text>{errMsg !== "" && <Text>{errMsg}</Text>}</Text> 
        </View>
